...
public class DetailsActivity extends AppCompatActivity {
    ...
    private InventorydpHelper dbHelper;
    EditText nameEdit;
    EditText priceEdit;
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEdit.setText(cursor.getString(cursor.getColumnIndex(InventoryContract.StockEntry.COLUMN_NAME)));
        priceEdit.setText(cursor.getString(cursor.getColumnIndex(InventoryContract.StockEntry.COLUMN_PRICE)));
        quantityEdit.setText(cursor.getString(cursor.getColumnIndex(InventoryContract.StockEntry.COLUMN_QUANTITY)));
        supplierNameEdit.setText(cursor.getString(cursor.getColumnIndex(InventoryContract.StockEntry.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEdit.setText(cursor.getString(cursor.getColumnIndex(InventoryContract.StockEntry.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEdit.setText(cursor.getString(cursor.getColumnIndex(InventoryContract.StockEntry.COLUMN_SUPPLIER_EMAIL)));
